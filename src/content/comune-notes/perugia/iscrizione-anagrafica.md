...
sources:
  - title: "Comune di Perugia — Attestazione di iscrizione anagrafica e soggiorno permanente (cittadini UE)"
    ...
    accessed: 2026-06-11
  - title: 'Comune di Perugia — Dichiarazione di cambio di residenza'
    url: 'https://www.comune.perugia.it/servizio/anagrafe-dichiarazione-di-cambio-di-residenza/'
    accessed: 2026-06-11
---

In **Perugia**, EU citizens intending to stay more than three months must request
...
- **Eligibility:** the right to reside beyond three months requires sufficient
  ...
  right automatically.
- **Validity:** the *attestazione di iscrizione anagrafica* is valid 5 years; the
  *attestazione di soggiorno permanente* has unlimited validity.
