...
export const ui: Record<Locale, Strings> = {
  en: {
    ...
    footerNav: [
      ...
      { href: '/from/united-states', label: 'From the USA' },
  ...
  it: {
    ...
    footerNav: [
      ...
      { href: '/it/renting', label: 'Affittare casa' },
      { href: '/it/schools', label: 'Scuola' },
      { href: '/it/driving', label: 'Patente' },
      { href: '/it/banking', label: 'Conto bancario' },
      { href: '/it/pets', label: 'Animali' },
      { href: '/it/non-eu', label: 'Cittadini non UE' },
      { href: '/it/from/united-states', label: 'Dagli Stati Uniti' },
