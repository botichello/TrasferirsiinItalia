...
sources:
  ...
  - title: 'Ministero del Lavoro (Integrazione Migranti) — aumento 2024 del contributo per l''iscrizione volontaria al SSN'
    ...
    accessed: 2026-07-02
  - title: 'Ministero della Salute — Modalità per calcolare il contributo volontario (PDF)'
...
L'iscrizione ti dà una *tessera sanitaria* e ti consente di scegliere un *medico
di base* gratuito nel momento della prestazione.
...
1. Recati alla ASL della zona in cui sei residente.
2. Presenta documento, codice fiscale, attestazione di iscrizione anagrafica e
   prova della tua condizione.
...
Con il codice fiscale, la residenza registrata e l'iscrizione al SSN, hai
completato i passaggi legali fondamentali per stabilirti in Italia come cittadino
UE.
