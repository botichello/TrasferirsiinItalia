...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines = [
    ...
    '',
    '## By source country',
    '> What differs because of where you are moving FROM, as opposed to the',
    '> destination detail the rest of the site is organised around.',
    `- [Moving from the United States](${base}/from/united-states): hub for what differs for Americans. Italian: ${base}/it/from/united-states`,
    `- [Arriving from the United States](${base}/from/united-states/arriving): 90 days visa-free is not a relocation route (artt. 4-5 TU 286/1998); consular jurisdiction; apostille chain; ETIAS not in operation; EES since 10 Apr 2026; one-year driving clock from anagrafe registration.`,
    `- [US taxes and social security](${base}/from/united-states/taxes): citizenship-based taxation, FEIE $132,900 (2026), FBAR $10k aggregate, Form 8938, treaty saving clause and art. 23(4) credit ordering, no detached-worker rule in the US-Italy totalization agreement, Medicare does not cover care abroad.`,
    '',
