...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines = [
    ...
    `- [Moving from the United States](${base}/from/united-states): licence not convertible, and the obligations that follow a US passport. Italian: ${base}/it/from/united-states`,
    '',
