...
metaDescription: "How EU/EEA residents enrol in Italy's health service (SSN), get a tessera sanitaria, and choose a family doctor."
step: 3
...
**ASL** (Azienda Sanitaria Locale). Enrolment gives you a *tessera sanitaria* and
lets you choose a *medico di base* (family doctor) free at the point of care.
...
1. Go to the ASL for the area where you are registered as resident.
2. Present your ID, codice fiscale, *attestazione di iscrizione anagrafica*, and
...
With the codice fiscale, registered residency, and SSN enrolment in place, you
have completed the core legal steps of establishing yourself in Italy as an EU
citizen.
