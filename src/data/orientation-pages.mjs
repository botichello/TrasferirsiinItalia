...
export const orientationPages = [
  ...
  { en: 'src/pages/non-eu/digital-nomad.astro', it: 'src/pages/it/non-eu/digital-nomad.astro', lastVerified: '2026-08-04', reviewBy: '2027-02-04', title: "Italy's digital nomad visa", titleIt: 'Il visto per nomadi digitali' },
  { en: 'src/pages/non-eu/elective-residence.astro', it: 'src/pages/it/non-eu/elective-residence.astro', lastVerified: '2026-08-04', reviewBy: '2027-02-04', title: "Italy's elective residence visa", titleIt: 'Il visto per residenza elettiva' },
  ...
  { en: 'src/pages/non-eu/family-reunification.astro', it: 'src/pages/it/non-eu/family-reunification.astro', lastVerified: '2026-08-04', reviewBy: '2027-02-04', title: 'Family reunification (non-EU sponsors)', titleIt: 'Ricongiungimento familiare (sponsor non UE)' },
  { en: 'src/pages/non-eu/long-term-residence.astro', it: 'src/pages/it/non-eu/long-term-residence.astro', lastVerified: '2026-08-04', reviewBy: '2027-02-04', title: 'The EU long-term residence permit', titleIt: 'Il permesso UE per soggiornanti di lungo periodo' },
  { en: 'src/pages/non-eu/blue-card.astro', it: 'src/pages/it/non-eu/blue-card.astro', lastVerified: '2026-08-04', reviewBy: '2027-02-04', title: 'The EU Blue Card in Italy', titleIt: 'La Carta blu UE in Italia' },
  ...
  { en: 'src/pages/driving.astro', it: 'src/pages/it/driving.astro', lastVerified: '2026-08-04', reviewBy: '2027-02-04', title: 'Driving in Italy on a foreign licence', titleIt: 'Guidare in Italia con la patente estera' },
  { en: 'src/pages/banking.astro', it: 'src/pages/it/banking.astro', lastVerified: '2026-08-04', reviewBy: '2027-02-04', title: 'Opening a bank account in Italy', titleIt: 'Aprire un conto bancario in Italia' },
